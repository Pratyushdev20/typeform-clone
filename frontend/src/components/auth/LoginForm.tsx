    ...
    <div className={styles.authPage}>
      ...
      <main className={styles.authContent}>
        <div className={styles.authCard}>
          ...
          {/* Social Sign In (Visual Demo) */}
          <div className={styles.socialButtons}>
            <button
              type="button"
              className={styles.socialBtn}
              onClick={() => setError("Google OAuth is disabled. Please use email & password.")}
            >
            ...
            <button
              type="button"
              className={styles.socialBtn}
              onClick={() => setError("Microsoft OAuth is disabled. Please use email & password.")}
            >
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            >
              {loading ? <div className={styles.spinner} /> : "Continue with email"}
            </button>
          </form>
          ...
          <button
            ...
            onClick={() => setError("SSO is only available for Enterprise plans.")}
          >
            Log in with SSO
          </button>
